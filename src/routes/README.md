...
| ----- | ---- | ---- | ---- |
| `/[lng]/gallery` | - | `LngGallery` | `<LngGallery.Link>` |
| `/[lng]` | - | `Lng` | `<Lng.Link>` |
| `/` | - | `Home` | `<Home.Link>` |
...
- [ ] `/[lng]/gallery/page.info.ts`: Add search typing to if the page supports search paramaters
- [ ] Convert `Link` components for `/[lng]/gallery` to `<LngGallery.Link>`
- [ ] Convert `params` typing in `/[lng]/gallery/page.ts` to `z.infer<>`
- [ ] `/[lng]/page.info.ts`: Add search typing to if the page supports search paramaters
- [ ] Convert `Link` components for `/[lng]` to `<Lng.Link>`
- [ ] Convert `params` typing in `/[lng]/page.ts` to `z.infer<>`
